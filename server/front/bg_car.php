        ...
        <div class="row no-gutters slider-text justify-content-start align-items-center justify-content-center">
          <div class="col-lg-8 ftco-animated">
          	<div class="text w-100 text-center mb-md-5 pb-md-5">
	            ...
	            <a href="index.php?page=validSearch2&ville_depart=&ville_arrivee=&date_depart=&date_arrivee=" class="icon-wrap popup-vimeo d-flex align-items-center mt-4 justify-content-center">
